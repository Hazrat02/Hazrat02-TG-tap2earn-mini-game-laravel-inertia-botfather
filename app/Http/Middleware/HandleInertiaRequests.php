    ...
    public function rootView(Request $request): string
{
            ...
            $reloadHomePage =(!$previousUrlHasAdminPrefix && $currentUrlHasAdminPrefix) ||  ($previousUrlHasAdminPrefix && !$currentUrlHasAdminPrefix);
           Inertia::share('reloadPage', $reloadPage);
           Inertia::share('reloadHomePage', $reloadHomePage);
