  ...
  <body class="mini">
    ...
    <div class="menu-container">
      ...
      <div class="menu-bottuns">
        <Link :href="route('project')" class="button b-r">
          <img
        ...
        <Link :href="route('raffer')" class="button b-r">
          <img
            src="./../../../css/frontend/images/raffer.png"
            alt=""
            width="28px"
          />
          <span class="select-none">Friends</span>
        </Link>
        <Link :href="route('task')" h class="button b-r">
          <img
            src="./../../../css/frontend/images/coin.png"
            alt=""
            width="28px"
          />
          <span class="select-none">Task</span>
        </Link>
        <Link :href="route('wallet')" class="button">
          <img
            src="./../../../css/frontend/images/wallet.webp"
            alt=""
            width="28px"
          />
    ...
    <div class="progress-bar">
      <div
        class="progress"
        :style="{ width: `${(100 * powerValue) / totalValue}%` }"
      ></div>
    </div>
  </body>
</template>
